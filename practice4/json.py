...
for item in data["imdata"]:
  ...
  port_id = attrs["id"]
  sw = attrs["switchingSt"]

  print(f"ID: {port_id}, DN: {attrs['dn']}, AdminSt: {attrs['adminSt']}, SwitchingSt: {sw}, Mode: {attrs['mode']}")
...
print("\nEnabled ports:", ", ".join(enabled_ports))
print("Disabled ports:", ", ".join(disabled_ports))
print("Enabled count:", len(enabled_ports))
print("Disabled count:", len(disabled_ports))
print("Total shown:", len(data["imdata"]))
print("TotalCount field:", data.get("totalCount"))
